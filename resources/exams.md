...
## Índice histórico de parciales

*En esta sección se recopilan parciales de semestres anteriores con fines de práctica y estudio.  
Los enunciados y soluciones se publican como material de apoyo.*

---

## Parcial 1 · Lógica Proposicional
...
## Parcial 2 · Lógica Cuantificacional
...
## Parcial 3 · Conjuntos y Relaciones
...
## Parcial 4 · Álgebra de Boole

| Cohorte | Recursos |
|:--:|:--|
| 2025-2 | [Enunciado]({{ '/assets/exams/discretas1_parcial4_2025-2.pdf' | relative_url }}){: .label .label-red target="_blank" } [Solución]({{ '/assets/exams/discretas1_parcial4_2025-2_sol.pdf' | relative_url }}){: .label target="_blank" } |

**Material de apoyo**
- [Formulas parcial 4]({{ '/assets/exams/formulas_parcial4.pdf' | relative_url }}){: .label .label-yellow target="_blank" }
